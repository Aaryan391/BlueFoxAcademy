...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="/teacherdashboard"><i class="fas fa-home"></i> Dashboard</a></li>
            <li><a href="/add-course"><i class="fas fa-plus"></i> Add Course</a></li>
            <li><a href="/courselist"><i class="fas fa-book"></i> Manage Courses</a></li>
            <li><a href="/manageadmission"><i class="fas fa-book"></i> Manage Admission</a></li>
            <li><a href="/teacherprofile"><i class="fas fa-user"></i> My Profile</a></li>
        </ul>
    </div>
